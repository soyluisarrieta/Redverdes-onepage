      ...
      <section id="mas-recientes" class="-mt-40 relative">
        <div class="container pb-20">
          ...
          <div class="overflow-x-auto lg:overflow-visible relative">
            ...
            <div class="h-52 -mt-52 bg-gradient-to-t from-white via-white/70 to-white/0 sticky inset-x-0 top-0 left-0 z-10 rounded-b-xl pointer-events-none select-none"></div>
          </div>
      ...
      <div class="bg-no-repeat bg-cover bg-black/70 relative z-10" style="background-image: url(src/images/web/fondo-problematica.png);">
        <div class="container py-20 md:py-32 px-7 text-center text-white">
          ...
          <p class="w-full max-w-xl mx-auto">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea <a href="#" class="btn-link p-0 text-palette-primary-h underline">commodo consequat</a>. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.
          </p>
        </div>
